...
export function DataTable<TData, TValue>({
  ...
  return (
    <div>
      <div className="flex sm:flex-row flex-col-reverse gap-2 items-start sm:items-center py-4">
        {filter === "nisn" && (
          <Input
            placeholder={`Cari berdasarkan NISN`}
            value={(table.getColumn("nisn")?.getFilterValue() as string) ?? ""}
            onChange={(event) =>
        ...
        <div className="flex flex-row w-full items-start sm:items-center gap-2">
          <Select onValueChange={(value) => setFilter(value)}>
            <SelectTrigger className="max-w-max">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="nisn">NISN</SelectItem>
              <SelectItem value="nama">Nama</SelectItem>
            </SelectContent>
          </Select>
          <DropdownMenu>
            <DropdownMenuTrigger className="sm:ml-auto" asChild>
